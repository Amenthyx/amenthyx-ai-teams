...
|----------|-------------|
| Product Catalog | Browse, search, filter, sort, category |
| Cart | Add, remove, update quantity, save for later |
| Checkout | Address, shipping, payment, promo code, review |
| Payment | Credit card, PayPal, Apple Pay, gift card, split |
| Order Management | Confirmation, tracking, cancel, return, refund |
| Reviews | Write, edit, delete, rating, photo upload |
| Promotions | Coupon code, auto-discount, bundle, loyalty points |
| Shipping | Rate calculation, delivery estimate, tracking |
