...
|----------|-------------|
| Workflow Builder | Drag-and-drop, node connection, configuration |
| Trigger Setup | Schedule, webhook, event, manual |
| Execution | Run, pause, resume, cancel, retry |
| Error Handling | Node failure, retry logic, fallback path |
| Credential Management | Add, edit, test, delete - secure storage |
| Template | Browse, deploy, customize, share |
| Version Control | Workflow versioning, diff, rollback |
| Monitoring | Execution history, logs, metrics, alerts |
