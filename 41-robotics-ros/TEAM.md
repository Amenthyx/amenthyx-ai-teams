...
|----------|-------------|
| Robot Startup | Boot sequence, node init, sensor calibration |
| Motion Control | Joint movement, trajectory, collision avoidance |
| Navigation | Path planning, obstacle detection, localization |
| Safety | E-stop, speed limits, workspace boundaries |
| Teleoperation | Joystick control, latency, emergency stop |
| Simulation | Gazebo scenarios, physics accuracy |
| Diagnostics | Error reporting, health monitoring, battery |
| Multi-Robot | Coordination, task allocation, collision avoidance |
