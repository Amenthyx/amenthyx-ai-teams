...
|----------|-------------|
| Spark Jobs | Submit, monitor, cancel, retry, resource allocation |
| Data Ingestion | File formats, schema evolution |
| Streaming | Structured Streaming, watermarks, checkpointing |
| Data Quality | Schema validation, partition management |
| Scheduling | Airflow DAGs, dependency management, backfill |
| Performance | Query plans, caching, broadcast joins |
| Monitoring | Job metrics, stage progress, task failures |
| Catalog | Table registration, metadata, access control |
