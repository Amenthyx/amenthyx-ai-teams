...
|----------|-------------|
| WebSocket | Connect, disconnect, reconnect, heartbeat, ordering |
| Message Delivery | At-least-once, exactly-once, causal ordering |
| Presence | Online/offline status, typing indicator, last seen |
| Latency | P50, P95, P99 measurement, budget enforcement |
| Event Sourcing | Event append, projection, snapshot, replay |
| Stream Processing | Windowing, aggregation, late arrivals |
| Failover | Connection migration, state recovery, data replay |
| Monitoring | Connection count, message rate, error rate, lag |
