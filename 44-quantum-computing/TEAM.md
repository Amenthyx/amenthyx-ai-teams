...
|----------|-------------|
| Circuit Design | Gate placement, qubit allocation, visualization |
| Simulation | Statevector, noise model, resource estimation |
| Execution | Backend selection, job submission, result retrieval |
| Visualization | Bloch sphere, histogram, circuit diagram |
| Algorithm | VQE, QAOA, Grover - parameter tuning, convergence |
| Transpilation | Circuit optimization, gate decomposition, routing |
| Results | Measurement statistics, expectation values |
| Benchmarking | Gate time, coherence, error rates, quantum volume |
