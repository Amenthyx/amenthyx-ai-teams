...
|----------|-------------|
| Render Output | Format, codec, resolution, frame rate, color space |
| Preview | Real-time playback, scrubbing, quality levels |
| Timeline | Navigation, zoom, marker, trim, layer management |
| Effects | Apply, configure, keyframe, preview, render quality |
| Import/Export | File format support, metadata, batch processing |
| Streaming | Connection, bitrate, latency, reconnection |
| Audio Sync | Lip sync, latency compensation, normalization |
| Quality Control | Color accuracy, audio levels, artifact detection |
