...
|----------|-------------|
| Input Systems | Keyboard, mouse, gamepad, touch - all bindings |
| Save/Load | Save game, load game, auto-save, cloud sync |
| Multiplayer | Matchmaking, session join/leave, sync, latency |
| UI/HUD | Menu navigation, settings, pause, inventory |
| Audio | SFX triggers, music transitions, volume controls |
| Physics | Collision detection, ragdoll, particle effects |
| AI Behavior | Pathfinding, decision trees, difficulty scaling |
| Platform | PC, console, mobile - platform-specific features |
