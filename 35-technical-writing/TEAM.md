...
|----------|-------------|
| Documentation Site | Navigation, search, versioning, responsive |
| API Documentation | Endpoint accuracy, parameters, code examples |
| Search | Full-text, autocomplete, filtering, relevant results |
| PDF Export | Layout, pagination, table of contents, links |
| Versioning | Version selector, deprecation notices |
| Feedback | Thumbs up/down, edit suggestion, issue creation |
| Localization | Language selector, translation accuracy, RTL |
| Interactive | Playground, sandbox, live editor, preview |
