...
|----------|-------------|
| Test Framework | Configuration, runner, reporter, parallel execution |
| E2E Tests | Cross-browser, responsive, flaky detection |
| API Tests | Contract testing, schema validation, load |
| Visual Regression | Baseline capture, diff detection, approval |
| Performance | Load, stress, soak, spike - latency budgets |
| Mutation Testing | Stryker config, mutation score, survivors |
| Coverage | Line, branch, function - threshold enforcement |
| Meta-QA | Test the tests - assertion quality, edge coverage |
