...
|----------|-------------|
| Course Navigation | Lessons, modules, progress, bookmarks |
| Assessment | Quiz, exam, assignment, auto-grading, rubric |
| Progress | Completion tracking, grade book, certificate |
| Collaboration | Discussion forum, peer review, group project |
| Content Authoring | Rich text editor, media embed, quiz builder |
| Enrollment | Self-enroll, invite, waitlist, prerequisite |
| Mobile Learning | Offline download, responsive, push notification |
| Analytics | Engagement metrics, time-on-task, drop-off |
