...
|----------|-------------|
| Spatial UI | Gaze, hand tracking, controller - button interactions |
| 3D Rendering | Object placement, occlusion, lighting, LOD |
| Performance | Frame rate (90fps VR, 60fps AR), thermal throttling |
| Interaction | Grab, throw, push, pinch, drag - physics response |
| Comfort | Locomotion modes, comfort vignette, snap turn |
| Multiplayer | Avatar sync, voice chat, shared space |
| Accessibility | Seated mode, one-hand mode, subtitle placement |
| Platform | Quest, Vision Pro, HoloLens - platform-specific |
