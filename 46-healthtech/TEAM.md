...
|----------|-------------|
| Patient Portal | Login, profile, medical records, appointment |
| Telehealth | Video call, chat, file sharing, prescription |
| EHR | Record view, lab results, prescriptions, allergy |
| HIPAA Compliance | PHI access audit, encryption, breach notification |
| Consent | Sign, revoke, view history, proxy consent |
| Messaging | Patient-provider chat, file attachment, urgency |
| Billing | Statement view, payment, insurance filing |
| Appointment | Book, reschedule, cancel, reminder, waitlist |
