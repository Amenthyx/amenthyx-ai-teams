...
|----------|-------------|
| Installation | npm/pip/cargo install - every package manager |
| Configuration | Config file, env vars, CLI flags - all options |
| API Surface | Every public function, method, class - behavior |
| CLI Commands | Every command, subcommand, flag, help, version |
| Documentation | README, Getting Started, API reference, examples |
| Contributing | Fork, branch, PR workflow, test requirements |
| Changelog | Semantic versioning, breaking changes, migration |
| Backward Compat | Major version upgrades, deprecation, shims |
