...
|----------|-------------|
| Keyboard | Tab order, focus trap, skip links, shortcut keys |
| Screen Reader | ARIA roles, labels, live regions, landmarks |
| Visual | Color contrast (4.5:1), focus indicators, text resize |
| Motor | Click target size (44px), gesture alternatives |
| Forms | Label association, error identification, instructions |
| Dynamic Content | Live regions, focus management, state announcements |
| Tools | axe-core, WAVE, Lighthouse, NVDA, VoiceOver, JAWS |
| Legal | WCAG 2.1 AA, Section 508, EN 301 549, ADA |
